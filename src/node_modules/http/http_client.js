...
export class HttpClient {
	...
	/**
	 * Make the HTTP request. Doesn't have the ability to cancel the request.
	 ...
	 * @returns {status: number, headers: object, body: string} the server's response */
	async requestAsync({ host, port, method, path, headers = {}, body = "" }) {
		const { responsePromise } = this.request({ host, port, method, path, headers, body });
